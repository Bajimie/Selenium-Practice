...
public class demoAutomation {
    ...
    public void login() {
        ...
        //Enter username
        driver.findElement(By.xpath("//input[@id='email']")).sendKeys("08130268726");

        //Enter password
        driver.findElement(By.xpath("//input[@id='pass']")).sendKeys("venux;");
        ...
        driver.findElement(By.xpath("//span[contains(text(),'Bajimi Kolawole')]")).click();
